...
parse_fn = function() {
  ...
  __privateSet(this, _requestValues, parse(raw, { decode: identity }));
};
...
const _AstroSession = class _AstroSession {
  constructor(cookies, {
   ...
   */
  async get(key) {
    return (await __privateMethod(this, _AstroSession_instances, ensureData_fn).call(this)).get(key)?.data;
  }
  /**
   * Checks if a session value exists.
   */
  async has(key) {
    return (await __privateMethod(this, _AstroSession_instances, ensureData_fn).call(this)).has(key);
  }
  /**
   * Gets all session values.
   */
  async keys() {
    return (await __privateMethod(this, _AstroSession_instances, ensureData_fn).call(this)).keys();
  }
  /**
   * Gets all session values.
   */
  async values() {
    return [...(await __privateMethod(this, _AstroSession_instances, ensureData_fn).call(this)).values()].map((entry) => entry.data);
  }
  /**
   * Gets all session entries.
   */
  async entries() {
    return [...(await __privateMethod(this, _AstroSession_instances, ensureData_fn).call(this)).entries()].map(([key, entry]) => [key, entry.data]);
  }
  /**
  ...
  async regenerate() {
    ...
    try {
      data = await __privateMethod(this, _AstroSession_instances, ensureData_fn).call(this);
    } catch (err) {
    ...
    await __privateMethod(this, _AstroSession_instances, setCookie_fn).call(this);
  ...
  async [PERSIST_SYMBOL]() {
    ...
    const storage = await __privateMethod(this, _AstroSession_instances, ensureStorage_fn).call(this);
    if (__privateGet(this, _dirty) && __privateGet(this, _data)) {
      const data = await __privateMethod(this, _AstroSession_instances, ensureData_fn).call(this);
  ...
  async load(sessionID) {
    ...
    __privateSet(this, _data, void 0);
    await __privateMethod(this, _AstroSession_instances, setCookie_fn).call(this);
    await __privateMethod(this, _AstroSession_instances, ensureData_fn).call(this);
  }
};
...
ensureData_fn = async function() {
  ...
  __privateGet(this, _data) ?? __privateSet(this, _data, /* @__PURE__ */ new Map());
  const raw = await storage.get(__privateMethod(this, _AstroSession_instances, ensureSessionID_fn).call(this));
  if (!raw) {
    return __privateGet(this, _data);
  }
  try {
...
ensureStorage_fn = async function() {
  ...
  if (__privateGet(this, _config).driver === "fs" || __privateGet(this, _config).driver === "fsLite" || __privateGet(this, _config).driver === "fs-lite") {
    (_a = __privateGet(this, _config)).options ?? (_a.options = {});
    __privateGet(this, _config).driver = "fs-lite";
    (_b = __privateGet(this, _config).options).base ?? (_b.base = ".astro/session");
  }
  let driver = null;
  try {
...
let AstroSession = _AstroSession;
...
const _RenderContext = class _RenderContext {
  constructor(pipeline, locals, middleware, actions, pathname, request, routeData, status, clientAddress, cookies = new AstroCookies(request), params = getParams(routeData, pathname), url = ((_a) => __privateMethod(_a = _RenderContext, _RenderContext_static, createNormalizedUrl_fn).call(_a, request.url))(), props = {}, partial = void 0, shouldInjectCspMetaTags = !!pipeline.manifest.csp, session = pipeline.manifest.sessionConfig ? new AstroSession(cookies, pipeline.manifest.sessionConfig, pipeline.runtimeMode) : void 0) {
    __privateAdd(this, _RenderContext_instances);
    /**
  ...
  async render(componentInstance, slots = {}) {
    ...
    const lastNext = async (ctx, payload) => {
      ...
      if (payload) {
        ...
        this.url = __privateMethod(_a = _RenderContext, _RenderContext_static, createNormalizedUrl_fn).call(_a, this.request.url);
  ...
  createActionAPIContext() {
    ...
    const rewrite = async (reroutePayload) => {
      return await __privateMethod(this, _RenderContext_instances, executeRewrite_fn).call(this, reroutePayload);
    };
    return {
  ...
  createAstro(result, astroStaticPartial, props, slotValues, apiContext) {
    ...
    if (this.isRewriting) {
      astroPagePartial = __privateSet(this, _astroPagePartial, this.createAstroPagePartial(
        result,
        astroStaticPartial,
        apiContext
      ));
    } else {
      astroPagePartial = __privateGet(this, _astroPagePartial) ?? __privateSet(this, _astroPagePartial, this.createAstroPagePartial(
        result,
        astroStaticPartial,
        apiContext
      ));
  ...
  computeCurrentLocale() {
    ...
    __privateSet(this, _currentLocale, computedLocale ?? fallbackTo);
    return __privateGet(this, _currentLocale);
  }
  computePreferredLocale() {
    ...
    if (!i18n) return;
    return __privateGet(this, _preferredLocale) ?? __privateSet(this, _preferredLocale, computePreferredLocale(request, i18n.locales));
  }
  computePreferredLocaleList() {
    ...
    if (!i18n) return;
    return __privateGet(this, _preferredLocaleList) ?? __privateSet(this, _preferredLocaleList, computePreferredLocaleList(request, i18n.locales));
  }
};
_RenderContext_static = new WeakSet();
createNormalizedUrl_fn = function(requestUrl) {
...
_RenderContext_instances = new WeakSet();
executeRewrite_fn = async function(reroutePayload) {
  var _a;
...
__privateAdd(_RenderContext, _RenderContext_static);
let RenderContext = _RenderContext;
...
const _App = class _App {
  ...
  async render(request, renderOptions) {
    ...
    if (routeData) {
      ...
      __privateGet(this, _logger2).debug("router", "RouteData:\n" + routeData);
    }
    if (locals) {
      if (typeof locals !== "object") {
        const error2 = new AstroError(LocalsNotAnObject);
        __privateGet(this, _logger2).error(null, error2.stack);
    ...
    if (!routeData) {
      ...
      __privateGet(this, _logger2).debug("router", "Astro matched the following route for " + request.url);
      __privateGet(this, _logger2).debug("router", "RouteData:\n" + routeData);
    }
    if (!routeData) {
    ...
    if (!routeData) {
      __privateGet(this, _logger2).debug("router", "Astro hasn't found routes that match " + request.url);
      __privateGet(this, _logger2).debug("router", "Here's the available routes:\n", __privateGet(this, _manifestData));
      return __privateMethod(this, _App_instances, renderError_fn).call(this, request, {
        locals,
        status: 404,
        clientAddress,
    ...
    try {
      ...
      __privateGet(this, _logger2).error("router", "Error while trying to render the route " + routeData.route);
  ...
  if (__privateGet(this, _manifest).i18n && (__privateGet(this, _manifest).i18n.strategy === "domains-prefix-always" || __privateGet(this, _manifest).i18n.strategy === "domains-prefix-other-locales" || __privateGet(this, _manifest).i18n.strategy === "domains-prefix-always-no-redirect")) {
    ...
    if (host && protocol) {
      ...
      try {
        ...
        __privateGet(this, _logger2).error("router", `Error: ${e}`);
      }
    }
  }
  return pathname;
...
renderError_fn = async function(request, {
  ...
  if (errorRouteData) {
    ...
    if (!mod || typeof mod.page !== "function") {
      const response2 = __privateMethod(this, _App_instances, mergeResponses_fn).call(this, new Response(null, { status }), originalResponse);
