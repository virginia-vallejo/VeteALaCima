import { a as isRemoteAllowed, j as joinPaths, i as isRemotePath, t as typeHandlers, b as types } from "./index.BLDoqA60.js";
import { A as AstroError, E as ExpectedImage, L as LocalImageUsedWrongly, M as MissingImageDimension, U as UnsupportedImageFormat, I as IncompatibleDescriptorOptions, g as UnsupportedImageConversion, t as toStyleString, N as NoImageMetadata, F as FailedToFetchRemoteImageDimensions, h as ExpectedImageOptions, i as ExpectedNotESMImage, j as InvalidImageService, c as createAstro, a as createComponent, k as ImageMissingAlt, m as maybeRenderHead, d as addAttribute, s as spreadAttributes, b as renderTemplate, l as ExperimentalFontsNotEnabled, n as FontFamilyNotFound, u as unescapeHTML } from "./astro/server.BqHzva7b.js";
...
async function getImage$1(options, imageConfig2) {
  ...
  if (options.inferSize && isRemoteImage(resolvedOptions.src) && isRemotePath(resolvedOptions.src)) {
    ...
    resolvedOptions.width ?? (resolvedOptions.width = result.width);
    resolvedOptions.height ?? (resolvedOptions.height = result.height);
  ...
  if (resolvedOptions.priority) {
    resolvedOptions.loading ?? (resolvedOptions.loading = "eager");
    resolvedOptions.decoding ?? (resolvedOptions.decoding = "sync");
    resolvedOptions.fetchpriority ?? (resolvedOptions.fetchpriority = "high");
    delete resolvedOptions.priority;
  } else {
    resolvedOptions.loading ?? (resolvedOptions.loading = "lazy");
    resolvedOptions.decoding ?? (resolvedOptions.decoding = "async");
    resolvedOptions.fetchpriority ?? (resolvedOptions.fetchpriority = "auto");
  }
  if (layout !== "none") {
...
const $$Image = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (layout !== "none") {
    props.layout ?? (props.layout = imageConfig.layout);
    props.fit ?? (props.fit = imageConfig.objectFit ?? "cover");
    props.position ?? (props.position = imageConfig.objectPosition ?? "center");
  }
...
}, "C:/Users/Usuario/Desktop/proyectos-para-presentar-en-portfolio/virgina vallejo/Proyecto/VeteALaCima/node_modules/astro/components/Image.astro", void 0);
...
}, "C:/Users/Usuario/Desktop/proyectos-para-presentar-en-portfolio/virgina vallejo/Proyecto/VeteALaCima/node_modules/astro/components/Picture.astro", void 0);
...
}, "C:/Users/Usuario/Desktop/proyectos-para-presentar-en-portfolio/virgina vallejo/Proyecto/VeteALaCima/node_modules/astro/components/Font.astro", void 0);
