...
function FAQAccordion() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto space-y-4", children: [
    faqs.map((faq, index) => /* @__PURE__ */ jsx(
      "div",
      {
        className: "relative group",
        style: { animationDelay: `${index * 0.1}s` },
        children: /* @__PURE__ */ jsxs("div", { className: "bg-white/10 backdrop-blur-xl rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:bg-white/15 border border-white/20 hover:border-white/30", children: [
          /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-16 h-16 border-t border-r border-white/20 rounded-tr-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" }),
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "flex-shrink-0 w-10 h-10 rounded-full bg-white/10 flex items-center justify-center border border-white/20 group-hover:bg-[#b4cfa6] group-hover:border-[#b4cfa6] transition-all duration-300", children: /* @__PURE__ */ jsx(
                  ChevronDown,
                  {
                    size: 20,
                    className: `text-white group-hover:text-[#0a1929] transition-all duration-300 ${openId === faq.id ? "rotate-180" : ""}`
                  }
                ) })
              ]
            }
          ...
          /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsx("div", { style: { overflow: "hidden" }, children: /* @__PURE__ */ jsx("div", { className: "px-6 pb-6 text-white/80 leading-relaxed border-t border-white/10 pt-4", children: faq.answer }) })
            }
          )
        ] })
      },
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-12 relative group", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[#b4cfa6]/10 rounded-2xl blur-xl" }),
      /* @__PURE__ */ jsxs("div", { className: "relative bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-8 text-center overflow-hidden group-hover:bg-white/15 hover:border-white/30 transition-all duration-500", children: [
        /* @__PURE__ */ jsx("div", { className: "absolute top-0 left-0 w-16 h-16 border-t border-l border-white/20 rounded-tl-xl opacity-50 group-hover:opacity-100 transition-opacity duration-300" }),
        /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 right-0 w-16 h-16 border-b border-r border-white/20 rounded-br-xl opacity-50 group-hover:opacity-100 transition-opacity duration-300" }),
        /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
          /* @__PURE__ */ jsx("div", { className: "w-12 h-12 mx-auto mb-4 bg-gradient-to-br from-[#b4cfa6]/20 to-[#b4cfa6]/10 backdrop-blur-md rounded-xl flex items-center justify-center border border-white/20", children: /* @__PURE__ */ jsx("span", { className: "text-2xl", children: "💬" }) }),
          /* @__PURE__ */ jsx("p", { className: "font-heading font-bold text-xl text-white mb-2", children: "¿Tenés otra pregunta?" }),
          /* @__PURE__ */ jsx("p", { className: "text-white/70 text-base mb-6", children: "Estamos acá para ayudarte. Contactanos directamente." }),
          /* @__PURE__ */ jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("span", { children: "Contactar por WhatsApp" }),
